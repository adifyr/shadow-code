# Instructions For The Dart Programming Language
...
- Always use decimals for `double` values. Example: `EdgeInsets.all(16.0)`, `TextStyle(fontSize: 14.0)`, `BorderRadius.circular(8.0)` etc.
...
- Prefer to use Switch Expressions over normal Switch-Case whenever a value is to be returned.

## How To Handle Data Class Pseudocode

The Dart language does not have data classes as a feature. If the user implies the use of a data class in the pseudocode, convert it to a final class like below:
...
# (REPEAT) Instructions For The Dart Programming Language
